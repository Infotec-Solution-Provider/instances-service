...
const parameters_service_1 = __importDefault(require("./parameters.service"));
const auth_service_1 = __importDefault(require("../auth/auth.service"));
class ParametersController {
    constructor() {
        this.router = (0, express_1.Router)();
        this.router.put("/api/instances/:clientName/parameters", auth_service_1.default.validateTokenMiddleware, (0, validateDto_1.default)(create_parameter_dto_1.CreateParametersDto), this.set);
    }
    async set(req, res) {
        ...
        const parameters = await parameters_service_1.default.upsert(findClient.name, req.body.parameters);
...
exports.default = ParametersController;
